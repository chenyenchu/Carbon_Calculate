...
<script lang="ts">
    ...
    function calculate() {
        i_emission = gasLiters * 2.36; // 假設每公升汽油會排放2.36公斤二氧化碳
    }
    ...
    const deleteRecord = async (id) => {
        await deleteDoc(doc(db, "record", id));//運用文件id刪除整筆資料
    };
...
<!-- Page Header Start -->
<div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s" style="background: linear-gradient(rgba(15, 66, 41, .6), rgba(15, 66, 41, .6)), url('/img/motor_bg.jpg') center center no-repeat;
background-size: cover;">
    <div class="container text-center py-5">
        <h1 class="display-3 text-white mb-4 animated slideInDown">機車</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="index.html">首頁</a></li>
                <li class="breadcrumb-item"><a href="personal_transport">個人運輸</a></li>
                <li class="breadcrumb-item active" aria-current="page">機車</li>
            </ol>
        </nav>
    </div>
</div>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="bg-light rounded p-4 p-sm-5 wow fadeInUp" data-wow-delay="0.1s">
                    <h1 align="center" class="display-5 mb-5">計算機車碳排量</h1>
                    <form>
                        <div class="row g-3" disabled>
                            ...
                            <div class="col-sm-15">
                                <div class="form-floating">
                                    <input type="number" class="form-control border-0" id="gas-liters" placeholder="油量（公升）" min="1" bind:value={gasLiters} required >
                                    <label for="gas-liters">油量（公升數）</label>
                                </div>
                            </div>
                            <div class="col-12 text-left">
                                <div class="form-floating">
                                    {#if i_emission > 0}
                                        <input type="text" class="form-control border-0" id=""  placeholder="Result" readonly disabled>
                                        <label for="result">增加的碳排量為 {i_emission.toFixed(2)} 公斤二氧化碳</label>
                                    {:else}
                                        <input type="text" class="form-control border-0" id="result"  placeholder="Result" readonly disabled>
                ...
                <div class="sm:p-7 p-4 bg-light">
                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody class="text-gray-600 dark:text-gray-100">
                            {#each records.filter(item => item.type === 'gasoline' && item.transportationType === "motor" && item.userId === id  ) as item, i}
                            <tr>
